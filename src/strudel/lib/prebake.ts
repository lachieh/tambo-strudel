...
export function prebake(): [string, Promise<void>][] {
  return [
    ['synthSounds', registerSynthSounds()],
    ['zzfxSounds', registerZZFXSounds()],
    ...
    ['tidalDrumMachines', samples(`${baseCDN}/tidal-drum-machines.json`, `${baseCDN}/tidal-drum-machines/machines/`, {
      prebake: true,
      tag: 'drum-machines',
    })],
    ['uzuDrumKit', samples(`${baseCDN}/uzu-drumkit.json`, `${baseCDN}/uzu-drumkit/`, {
      prebake: true,
      tag: 'drum-machines',
    })],
    ['uzuWavetable', samples(`${baseCDN}/uzu-wavetables.json`, `${baseCDN}/uzu-wavetables/`, {
      prebake: true,
    })],
    ...
    ['dirtSamples', samples(
      ...
      return aliasBank(`${baseCDN}/tidal-drum-machines-alias.json`);
    })]
  ];
}
